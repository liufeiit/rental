        ...
        <div class="box">
            <div class="box-header">
                <div class="box-search container">
                    <div><h1 style="font-size: 24px; text-align: center;">${stallName}-租金缴纳历史</h1></div>
                </div>
            </div>
            <div class="box-body">
                    ...
                    <c:forEach items="${histories}" var="history" varStatus="itemStatus">
                        <tr>
                            ...
                            <td class="operation-part center">
                                 ...
                                 <a title="下载" href="stall/downloadRentpayment/${history.id}"><span class="glyphicon glyphicon-download-alt"></span></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
