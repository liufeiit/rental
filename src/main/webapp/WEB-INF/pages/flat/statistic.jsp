...
<head>
    ...
    <script src="resources/flat/statistic.js"></script>
</head>

<!-- Bread line. -->
<section class="content-header">
    <h1>统计信息<small>公寓统计</small></h1>
    <ol class="breadcrumb">
        <li><a href="homePage"><i class="fa fa-dashboard"></i> 首页</a></li>
        <li>统计信息</li>
        <li class="active">公寓统计</li>
    </ol>
</section>
<!-- Content. -->
    ...
    <div class="row">
        <div class="box">
            <div class="box-header">
                <form role="form" action="flat/statistic" method="get">
                    ...
                    <div class="box-search container">
                        <div class="col-lg-4">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" name="flatName" value="${request.flatName}" placeholder="输入搜索的公寓名称">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="input-group">
                            ...
                            <td>${item.rentFee}
                                ...
                                <c:if test="${item.renterId >0 }">
                                    <c:if test="${item.isPayRent == 0 }">
	                                    &nbsp;&nbsp;
	                                    <a title="租金单" href="flat/payRentPage?flatId=${item.flatId}">填写租金单</a>
                                    </c:if>
                            ...
                            <td>${item.meterFee}
                                ...
                                <c:if test="${item.renterId >0 }">
                                    <c:if test="${item.isPayMeter == 0 }">
                                        &nbsp;&nbsp;
                                        <a title="电费单" href="flat/payMeterPage?flatId=${item.flatId}">填写电费单</a>
                                    </c:if>
