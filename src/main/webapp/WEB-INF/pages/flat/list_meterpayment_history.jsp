...
<section class="content-header">
    <h1>公寓管理<small>电费缴纳历史</small></h1>
    <ol class="breadcrumb">
        <li><a href="homePage"><i class="fa fa-dashboard"></i> 首页</a></li>
        <li>公寓管理</li>
        <li class="active">电费缴纳历史</li>
    </ol>
</section>
<!-- Content. -->
        ...
        <div class="box">
            <div class="box-header">
                <div class="box-search container">
                    <div><h1 style="font-size: 24px; text-align: center;">${flatName}-电费缴纳历史</h1></div>
                </div>
            </div>
            <div class="box-body">
                    ...
                    <c:forEach items="${histories}" var="history" varStatus="itemStatus">
                        <tr>
                            ...
                            <td class="operation-part center">
                                <a title="打印" href="stall/printMeterpayment/${history.id}"><span class="glyphicon glyphicon-print"></span></a>
                                <a title="下载" href="flat/downloadMeterpayment/${history.id}"><span class="glyphicon glyphicon-download-alt"></span></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
            ...
            <div class="box-footer clearfix">
                <c:set var="url" value="flat/listMeterpaymentHistory" />
